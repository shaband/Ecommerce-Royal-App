...
$('#styleSelector').append('' +
    ...
    '<ul>' +
    '<li>' +
    '<p class="selector-title main-title st-main-title"><b>Royal </b>Admin Customizer</p>' +
    ...
    '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for developing with us !</span>' +
    '<a href="https://www.facebook.com/smart.tatweer/" target="_blank" class="btn btn-facebook soc-icon m-b-20"><i class="icofont icofont-social-facebook"></i></a>' +
    '<a href="https://twitter.com/smarttatweer" target="_blank" class="btn btn-facebook soc-icon m-b-20"><i class="icofont icofont-social-twitter"></i></a>' +
